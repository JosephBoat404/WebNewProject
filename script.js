const mergword=["class", "id", "href", "body", "head", "div", "headings", "horizontal rules", "element", "attribute", "link", "meta", "style", "script", "title",
"comment", "style rule", "declaration block", "declaration", "property", "value", "selector", "padding", "margin", "font-family",
"variables", "loops", "if-else statements", "strings", "dates", "DOM mode", "events"] 
// Web Dev Terminology
...
function jspressed(array1){
    ...
    const elementinjs = ["variables", "loops", "if-else statements", "strings", "dates", "DOM mode", "events"];
...
function htmlpressed(array2){
    ...
    const htmlwords = ["class", "id", "href", "body", "head", "div", "headings", "horizontal rules", "element", "attribute", "link", "meta", "style", "script", "title"];
...
function csspressed(array3){
    ...
    const csswords = ["comment", "style rule", "declaration block", "declaration", "property", "value", "selector", "padding", "margin", "font-family"];
